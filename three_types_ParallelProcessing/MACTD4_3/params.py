...
actor_lr = 0.00046967212725637327     # 策略网络学习率（与TD3一致）
critic_lr = 0.0008999874896587596    # 价值网络学习率（与TD3一致）
num_episodes = 5000   # 回合数
hidden_dim = 64     # CTD4论文建议隐藏层维度256
gamma = 0.917         # 折扣因子
tau = 0.06016179447354208          # 软更新系数
buffer_size = 10000  # 回放池大小
batch_size = 256     # 批处理大小
policy_delay = 4     # CTD4保留TD3的延迟更新步数
noise_std = 0.8843228496003245      # 初始探索噪声
noise_clip = 1.0579393297086095     # 噪声剪辑范围
n_critics = 2            # CTD4核心：3个Critic（论文最优）
noise_decay_rate = 0.9986604302227976  # 噪声衰减率
min_noise_std = 0.03255804581841894      # 最小噪声标准差
