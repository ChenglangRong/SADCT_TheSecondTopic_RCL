...
def generate_combined_wafer_gantt(pm_excel_path, ll_excel_path, save_path='two_type_wafer_gantt_chart.png'):
    """
    生成整合版晶圆加工甘特图
    适配新格式：
    - PM文件单元格为"开始时间 驻留时长"
    ...
    # --------------------------
    processing_times = {
        "PM11": 113, "PM12": 123, "PM15": 123, "PM16": 113,
        "BM1": 0, "BM2": 0,  # BM时长从Excel中解析
        "PM21": 105, "PM22": 95, "PM23": 104, "PM24": 100, "PM25": 103, "PM26": 105,
        "取出晶圆": 10, "放入晶圆": 5
    }
        ...
        for _, row in module_data.iterrows():
            ...
            if module not in skip_block_modules:
                ...
                if residence_time > 0:
                    ...
                    # 新增：在红色驻留块上方显示驻留时长数字
                    res_center_x = res_start + residence_time / 2  # 驻留块水平中心
    ...
    # 标题与边框
    ax.set_title('two_type_wafer_gantt_chart',
...
if __name__ == "__main__":
    pm_excel_path = "C:\\Users\\Lenovo\\Desktop\\SADCT-AIpha different\\photo\\gantts\\two_PMs.xlsx"
    ll_excel_path = "C:\\Users\\Lenovo\\Desktop\\SADCT-AIpha different\\photo\\gantts\\two_LL.xlsx"
    output_image_path = "C:\\Users\\Lenovo\\Desktop\\SADCT-AIpha different\\photo\\gantts\\two_type_wafer_gantt_chart.png"
